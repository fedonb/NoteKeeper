...
import com.fedonb.notekeeper.databinding.ActivityItemsBinding
...
class ItemsActivity : AppCompatActivity(),
    ...
    private val noteLayoutManger by lazy {
        LinearLayoutManager(this)
    }
    private val noteRecyclerAdapter by lazy {
        NoteRecyclerAdapter(this, DataManager.notes)
    }
    private val courseLayoutManger by lazy {
    ...
    private fun displayNotes() {
        listItems.layoutManager = noteLayoutManger
    ...
    private fun displayCourses() {
        listItems.layoutManager = courseLayoutManger
